...
#### [v0.7.1](https://github.com/allen-cell-animated/simularium-website/compare/v0.7.0...v0.7.1)

- Feature/shorten names [`#363`](https://github.com/allen-cell-animated/simularium-website/pull/363)
- Bump moment from 2.29.3 to 2.29.4 [`#354`](https://github.com/allen-cell-animated/simularium-website/pull/354)
- Bump terser from 4.8.0 to 4.8.1 [`#353`](https://github.com/allen-cell-animated/simularium-website/pull/353)
- Bump eventsource from 1.1.0 to 1.1.1 [`#349`](https://github.com/allen-cell-animated/simularium-website/pull/349)
- update viewer to 3.3.3 [`93eea78`](https://github.com/allen-cell-animated/simularium-website/commit/93eea78db0119e7b4fc9d330162e50b6683b24c0)
- Update ux_issue.md [`e1ed1a5`](https://github.com/allen-cell-animated/simularium-website/commit/e1ed1a54a418a01d8a9905a3b858c530594a44bd)
- update viewer to 3.4.0 [`5d10b7d`](https://github.com/allen-cell-animated/simularium-website/commit/5d10b7d0ee507988d1edeefef3f38b72e01dd2aa)

#### [v0.7.0](https://github.com/allen-cell-animated/simularium-website/compare/v0.6.2...v0.7.0)

> 25 July 2022

- fix loading from url, was still assuming pure json format [`#345`](https://github.com/allen-cell-animated/simularium-website/pull/345)
- won't show time controls if there is no time range [`#343`](https://github.com/allen-cell-animated/simularium-website/pull/343)
- Feature/update drag n drop [`#339`](https://github.com/allen-cell-animated/simularium-website/pull/339)
- Bump moment from 2.29.1 to 2.29.2 [`#337`](https://github.com/allen-cell-animated/simularium-website/pull/337)
- Bump minimist from 1.2.5 to 1.2.6 [`#333`](https://github.com/allen-cell-animated/simularium-website/pull/333)
- reimplement drag and drop after viewer interface changes [`e5c4b91`](https://github.com/allen-cell-animated/simularium-website/commit/e5c4b910c914ee45c847977e585f07a81ca8cea7)
- refresh package-lock [`f4c8991`](https://github.com/allen-cell-animated/simularium-website/commit/f4c899167a25f8c229b49cd37501e62c5bf3f350)
- update viewer [`3b35346`](https://github.com/allen-cell-animated/simularium-website/commit/3b35346cae3a33c0ff7f66987ce3cdd1d97e982a)

#### [v0.6.2](https://github.com/allen-cell-animated/simularium-website/compare/v0.6.1...v0.6.2)

> 11 April 2022

- fix issue after merge main [`#336`](https://github.com/allen-cell-animated/simularium-website/pull/336)
- added citation [`#334`](https://github.com/allen-cell-animated/simularium-website/pull/334)
- fix horizontal scroll [`#332`](https://github.com/allen-cell-animated/simularium-website/pull/332)
- add image [`285ea6e`](https://github.com/allen-cell-animated/simularium-website/commit/285ea6e41852119ec55eb8581612b22a2b94a05c)
- adjustments to get title on one line [`0668772`](https://github.com/allen-cell-animated/simularium-website/commit/0668772c9f04dcb89eb421ddfb8d4da5883a77ae)
- some mobile styling [`ba5c5c2`](https://github.com/allen-cell-animated/simularium-website/commit/ba5c5c23c6de0c0e3fec92d758ffa8925f9619e9)

#### [v0.6.1](https://github.com/allen-cell-animated/simularium-website/compare/v0.6.0...v0.6.1)

> 10 March 2022

- Feature/update overview figure on landing page [`#330`](https://github.com/allen-cell-animated/simularium-website/pull/330)
- Fix/can't use arrow keys in input box of Upload by URL modal [`#323`](https://github.com/allen-cell-animated/simularium-website/pull/323)
- Bump url-parse from 1.5.3 to 1.5.10 [`#325`](https://github.com/allen-cell-animated/simularium-website/pull/325)
- Fix/current time is hard to read when number of decimal places keeps changing [`#317`](https://github.com/allen-cell-animated/simularium-website/pull/317)
- Bump follow-redirects from 1.14.7 to 1.14.8 [`#316`](https://github.com/allen-cell-animated/simularium-website/pull/316)
- Feature/place visual glossary key next to image on wider screens [`#314`](https://github.com/allen-cell-animated/simularium-website/pull/314)
- Fix/menus go off screen sometimes [`#312`](https://github.com/allen-cell-animated/simularium-website/pull/312)
- Feature/update visual glossary and landing page image [`#313`](https://github.com/allen-cell-animated/simularium-website/pull/313)
- Add return type to React components [`#307`](https://github.com/allen-cell-animated/simularium-website/pull/307)
- Update eslint from v5.14.1 to v8.7.0 [`#306`](https://github.com/allen-cell-animated/simularium-website/pull/306)
- Bump node-fetch from 2.6.5 to 2.6.7 [`#305`](https://github.com/allen-cell-animated/simularium-website/pull/305)
- Bump follow-redirects from 1.5.10 to 1.14.7 [`#301`](https://github.com/allen-cell-animated/simularium-website/pull/301)
- Fix/server error messages not displaying [`#303`](https://github.com/allen-cell-animated/simularium-website/pull/303)
- add UX design issue template [`7f23878`](https://github.com/allen-cell-animated/simularium-website/commit/7f23878a4dfaf15fc716bef6d648fc9ea99ddf88)

#### [v0.6.0](https://github.com/allen-cell-animated/simularium-website/compare/v0.5.1...v0.6.0)

> 19 January 2022

- Fix/nav bar overflowing when title is long [`#290`](https://github.com/allen-cell-animated/simularium-website/pull/290)
- Update viewer to v3.3.1 [`#299`](https://github.com/allen-cell-animated/simularium-website/pull/299)
- Update GitHub URLs to reflect new Simularium org [`#293`](https://github.com/allen-cell-animated/simularium-website/pull/293)
- Fix/can't step back to first frame of some trajectories [`#291`](https://github.com/allen-cell-animated/simularium-website/pull/291)
- Fix/previous trajectory persists when new trajectory fails to load [`#287`](https://github.com/allen-cell-animated/simularium-website/pull/287)
- Fix/old error message comes back after going to landing page [`#285`](https://github.com/allen-cell-animated/simularium-website/pull/285)
- Feature/treat warning messages as warnings [`#284`](https://github.com/allen-cell-animated/simularium-website/pull/284)
- Update viewer from v3.1.0 to v3.2.2 [`#278`](https://github.com/allen-cell-animated/simularium-website/pull/278)
- add workflow to create issue [`dfae6f2`](https://github.com/allen-cell-animated/simularium-website/commit/dfae6f2fb9a0286601a991a445142509e45c9f20)
- create issue only when opened [`16e2a52`](https://github.com/allen-cell-animated/simularium-website/commit/16e2a52ac755b35c48193985debb845236d373e4)
- Add @simularium/core-devs to CODEOWNERS [`2c278d7`](https://github.com/allen-cell-animated/simularium-website/commit/2c278d7d96201a5ab6e2bca983bc89101f48c8e1)

#### [v0.5.1](https://github.com/allen-cell-animated/simularium-website/compare/v0.5.0...v0.5.1)

> 2 November 2021

- Fix/agent list sometimes not loading for drag-and-drop [`#275`](https://github.com/allen-cell-animated/simularium-website/pull/275)

#### [v0.5.0](https://github.com/allen-cell-animated/simularium-website/compare/v0.4.0...v0.5.0)

> 1 November 2021

- Feature/auto-expand agent groups with no parent color [`#272`](https://github.com/allen-cell-animated/simularium-website/pull/272)
- update viewer [`#271`](https://github.com/allen-cell-animated/simularium-website/pull/271)
- remove unmodified state [`#265`](https://github.com/allen-cell-animated/simularium-website/pull/265)
- Feature/update viewer [`#262`](https://github.com/allen-cell-animated/simularium-website/pull/262)
- Fix/file load error handling [`#259`](https://github.com/allen-cell-animated/simularium-website/pull/259)
- Fix/broken styling in agent list [`#260`](https://github.com/allen-cell-animated/simularium-website/pull/260)
- Feature/update loading and sharing instructions in Quick Start [`#257`](https://github.com/allen-cell-animated/simularium-website/pull/257)
- Fix/spelling for Omar Quintero in acknowledgments [`#258`](https://github.com/allen-cell-animated/simularium-website/pull/258)
- Feature/load local geometry files [`#253`](https://github.com/allen-cell-animated/simularium-website/pull/253)
- Feature/list visualization options on landing page [`#256`](https://github.com/allen-cell-animated/simularium-website/pull/256)
- install new viewer and audit [`094ee25`](https://github.com/allen-cell-animated/simularium-website/commit/094ee25b57cc0fa988b6f952ad0d2e0c6606d384)
- remove agentColor map from state [`d5474c8`](https://github.com/allen-cell-animated/simularium-website/commit/d5474c8cd02b950f00cd24ee82679ac76108856c)
- using color from display data [`a5aceb0`](https://github.com/allen-cell-animated/simularium-website/commit/a5aceb0b86a8542fbec8eff83c5160d2ed93289f)
