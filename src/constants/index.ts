...
export const EMBEDDED_SIDE_PANEL_MINIMUM_WIDTH = 590;
export const EMBEDDED_STANDARD_CONTROLS_MINIMUM_WIDTH = 650;
export const EMBEDDED_STANDARD_CONTROLS_MINIMUM_HEIGHT = 320;
export const EMBEDDED_SCALE_BAR_MINIMUM_WIDTH = 550;
